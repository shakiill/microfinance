...
;(function ($) {
    $.fn.formset = function (opts) {
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            insertDeleteLink = function (row) {
                ...
                var delButtonHTML = '<div style="width: 55px"><a class="' + options.deleteCssClass + '" href="javascript:void(0)">' +
                    '<i class="fa fa-minus-square"></i></a></div>';
        ...
        if ($$.length) {
            ...
            var addButtonHTML = '<div class="row pb-3"><div class="col"><a class="' + options.addCssClass + '" href="javascript:void(0)">' +
                '<i class="fa fa-plus-square"></i></a></div></div>';
    ...
    $.fn.formset.defaults = {
        ...
        addCssClass: 'add-row btn btn-sm btn-primary',          // CSS class applied to the add link
        deleteCssClass: 'delete-row btn btn-sm btn-danger',    // CSS class applied to the delete link
